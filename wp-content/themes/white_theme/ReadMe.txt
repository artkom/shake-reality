...
*** Creating localized WordPress Themes
-------------------------------
When exporting themes automatically includes several language files
obtained from Wordpress Website at http://codex.wordpress.org/WordPress_Localization
Specifically French, German, Italian and Spanish translations in the Wordpress compliant file naming format:
